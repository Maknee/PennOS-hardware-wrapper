...
struct GTY((tag("GSS_OMP_ATOMIC_STORE_LAYOUT")))
    gomp_atomic_store : public gimple_statement_omp_atomic_store_layout
{
    /* No extra fields; adds invariant:
...
struct GTY((tag("GSS_OMP_ATOMIC_STORE_LAYOUT")))
    gimple_statement_omp_return : public gimple_statement_omp_atomic_store_layout
{
    /* No extra fields; adds invariant:
...
{
    const gimple_statement_with_memory_ops* mem_ops_stmt = dyn_cast<const gimple_statement_with_memory_ops*>(g);
    if (!mem_ops_stmt)
        return NULL_TREE;
...
{
    gimple_statement_with_memory_ops* mem_ops_stmt = dyn_cast<gimple_statement_with_memory_ops*>(g);
    if (!mem_ops_stmt)
        return NULL;
    return &mem_ops_stmt->vuse;
}
...
{
    gimple_statement_with_memory_ops* mem_ops_stmt = as_a<gimple_statement_with_memory_ops*>(g);
...
{
    const gimple_statement_omp_return* omp_return_stmt = as_a<const gimple_statement_omp_return*>(g);
