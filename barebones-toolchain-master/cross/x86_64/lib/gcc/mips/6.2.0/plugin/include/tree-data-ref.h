...
#define DR_ACCESS_FN(DR, I) DR_ACCESS_FNS(DR) \
    [I]
#define DR_NUM_DIMENSIONS(DR) DR_ACCESS_FNS(DR) \
                                  .length()
...
#define DDR_SUBSCRIPT(DDR, I) DDR_SUBSCRIPTS(DDR) \
    [I]
#define DDR_NUM_SUBSCRIPTS(DDR) DDR_SUBSCRIPTS(DDR) \
                                    .length()
...
extern struct data_dependence_relation* initialize_data_dependence_relation(struct data_reference*, struct data_reference*, vec<loop_p>);
