...
struct GTY((chain_next("%h.dw_loc_next"))) dw_loc_descr_node
{
    ...
    ENUM_BITFIELD(dwarf_location_atom)
    dw_loc_opc : 8;
...
extern struct dw_loc_descr_node* build_cfa_loc(dw_cfa_location*, HOST_WIDE_INT);
extern struct dw_loc_descr_node* build_cfa_aligned_loc(dw_cfa_location*, HOST_WIDE_INT offset, HOST_WIDE_INT alignment);
