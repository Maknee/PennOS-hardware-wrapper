...
bool Go_handle_option_auto(struct gcc_options* opts,
    ...
    const struct cl_option_handlers* handlers,
    diagnostic_context* dc);
bool Java_handle_option_auto(struct gcc_options* opts,
    struct gcc_options* opts_set,
    size_t scode, const char* arg, int value,
    unsigned int lang_mask, int kind,
    location_t loc,
...
enum opt_code
{
    ...
    OPT__no_sysroot_suffix
    = 60, /* --no-sysroot-suffix */
    ...
    = 429, /* -Wunsafe-loop-optimizations */
    ...
    OPT_fasan_shadow_offset_
    = 518, /* -fasan-shadow-offset= */
    OPT_fasm                                      = 519, /* -fasm */
    ...
    OPT_fdump_final_insns
    = 637, /* -fdump-final-insns */
    ...
    = 688, /* -fforce-classes-archive-check */
    ...
    = 724, /* -fhash-synchronization */
    /* OPT_fhelp = 725, */ /* -fhelp */
    /* OPT_fhelp_ = 726, */ /* -fhelp= */
    OPT_fhoist_adjacent_loads
    = 727, /* -fhoist-adjacent-loads */
    ...
    OPT_floop_nest_optimize
    = 805, /* -floop-nest-optimize */
    /* OPT_floop_optimize = 806, */ /* -floop-optimize */
    OPT_floop_parallelize_all
    = 807, /* -floop-parallelize-all */
    ...
    = 940, /* -freschedule-modulo-scheduled-loops */
    ...
    OPT_fschedule_fusion
    = 969, /* -fschedule-fusion */
    ...
    = 1023, /* -fstrict-volatile-bitfields */
