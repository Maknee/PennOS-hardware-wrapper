...
base_pool_allocator<TBlockAllocator>::initialize()
{
    ...
    {
        pool_usage* u = pool_allocator_usage.register_descriptor(this, new mem_location(m_location));
...
base_pool_allocator<TBlockAllocator>::release()
{
    ...
    {
        pool_allocator_usage.release_instance_overhead(this, (m_elts_allocated - m_elts_free) * m_elt_size);
    }
