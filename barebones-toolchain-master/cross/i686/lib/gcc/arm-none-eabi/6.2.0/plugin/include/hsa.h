...
private:
    /* Make the default constructor inaccessible.  */
    hsa_insn_phi()
        : hsa_insn_basic(1, HSA_OPCODE_PHI)
    {
    }
    /* All objects are deallocated by destroying their pool, so make delete
     inaccessible too.  */
...
private:
    /* Make the default constructor inaccessible.  */
    hsa_insn_br()
        : hsa_insn_basic(1, BRIG_OPCODE_CBR)
    {
    }
    /* All objects are deallocated by destroying their pool, so make delete
     inaccessible too.  */
...
private:
    /* Make the default constructor inaccessible.  */
    hsa_insn_sbr()
        : hsa_insn_basic(1, BRIG_OPCODE_SBR)
    {
    }
    /* All objects are deallocated by destroying their pool, so make delete
     inaccessible too.  */
...
private:
    /* Make the default constructor inaccessible.  */
    hsa_insn_cmp()
        : hsa_insn_basic(1, BRIG_OPCODE_CMP)
    {
    }
    /* All objects are deallocated by destroying their pool, so make delete
     inaccessible too.  */
...
private:
    /* Make the default constructor inaccessible.  */
    hsa_insn_mem()
        : hsa_insn_basic(1, BRIG_OPCODE_LD)
    {
    }
    /* All objects are deallocated by destroying their pool, so make delete
     inaccessible too.  */
...
private:
    /* Make the default constructor inaccessible.  */
    hsa_insn_atomic()
        : hsa_insn_mem(1, BRIG_KIND_NONE, BRIG_TYPE_NONE)
    {
    }
    /* All objects are deallocated by destroying their pool, so make delete
     inaccessible too.  */
...
private:
    /* Make the default constructor inaccessible.  */
    hsa_insn_seg()
        : hsa_insn_basic(1, BRIG_OPCODE_STOF)
    {
    }
    /* All objects are deallocated by destroying their pool, so make delete
     inaccessible too.  */
...
private:
    /* Make the default constructor inaccessible.  */
    hsa_insn_call()
        : hsa_insn_basic(0, BRIG_OPCODE_CALL)
    {
    }
    /* All objects are deallocated by destroying their pool, so make delete
     inaccessible too.  */
