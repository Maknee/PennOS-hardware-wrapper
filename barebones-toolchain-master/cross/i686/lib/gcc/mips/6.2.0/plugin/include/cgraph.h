...
public:
    ...
    ENUM_BITFIELD(ld_plugin_symbol_resolution)
    resolution : 8;
...
{
    cgraph_node* n = dyn_cast<cgraph_node*>(symtab_node::ultimate_alias_target(availability));
    if (!n && availability)
...
{
    varpool_node* n = dyn_cast<varpool_node*>(symtab_node::ultimate_alias_target(availability));
