...
enum opt_code
{
    ...
    = 268, /* -Wincompatible-pointer-types */
    ...
    = 432, /* -Wunsafe-loop-optimizations */
    ...
    = 691, /* -fforce-classes-archive-check */
    ...
    = 727, /* -fhash-synchronization */
    /* OPT_fhelp = 728, */ /* -fhelp */
    /* OPT_fhelp_ = 729, */ /* -fhelp= */
    OPT_fhoist_adjacent_loads
    = 730, /* -fhoist-adjacent-loads */
    ...
    = 943, /* -freschedule-modulo-scheduled-loops */
    ...
    = 1026, /* -fstrict-volatile-bitfields */
